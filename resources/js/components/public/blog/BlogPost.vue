              ...
              <div class="row">
                <div class="span8">
                  <div class="post-image">
                    ...
                    <img :src="post.photo" alt="" width="800" height="200"/>
                  </div>
                  <p>
                  ...
                  <div class="bottom-article">
                    <ul class="meta-post">
                      ...
                      <li><i class="icon-folder-open"></i><a href="#"  v-if="post.category" > {{post.category.cat_name}}</a></li>
